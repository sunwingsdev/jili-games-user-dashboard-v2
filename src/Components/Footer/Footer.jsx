...
const Footer = () => {
  return (
    <footer className="relative w-full bg-bgSidebar text-white py-6 border-b   border-textPrimary shadow-inner overflow-hidden">
      {/* Background glow */}
      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 text-sm tracking-wide font-light">
        ...
        <p className="text-center">
          Copy Right @ 2025 by{" "}
          <span className="font-bold text-white hover:text-textYellow hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.35)] transition duration-300">
